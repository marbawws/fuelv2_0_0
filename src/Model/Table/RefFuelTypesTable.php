 ...
 * RefFuelTypes Model
 *
 * @property \App\Model\Table\FuelsTable&\Cake\ORM\Association\BelongsTo $Fuels
 * @property \App\Model\Table\FuelSpecificsTable&\Cake\ORM\Association\BelongsTo $FuelSpecifics
 *
...
class RefFuelTypesTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['fuel_specific_id'], 'FuelSpecifics'));
