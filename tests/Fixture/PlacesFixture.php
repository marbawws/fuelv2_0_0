...
class PlacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Foreign_key_photoId_de_photos_' => ['type' => 'index', 'columns' => ['photo_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'Foreign_key_photoId_de_photos_' => ['type' => 'foreign', 'columns' => ['photo_id'], 'references' => ['photos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
